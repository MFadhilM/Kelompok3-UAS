...
// ignore_for_file: use_key_in_widget_constructors, unused_element, duplicate_ignore, avoid_print, prefer_const_constructors, unnecessary_null_comparison, unnecessary_new, await_only_futures
...
class _beritamdrState extends State<beritamdr> {
  ...
  final response = await http.Request('get', Uri.parse("https://tokoonlineyanto.000webhostapp.com/listnews.php"));
